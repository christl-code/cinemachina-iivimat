...
namespace iivimat
{
    public class NodeViewOrientationTransform : NodeViewReaction
    {
        SerializedObject so;
        ...
        public NodeViewOrientationTransform(NodeModelReaction nodeModel) : base(nodeModel)
        {
            ...
            fieldTransformValues = new PropertyField(propTransformValues);
